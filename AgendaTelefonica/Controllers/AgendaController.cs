...
namespace AgendaTelefonica.Controllers
{
    public class AgendaController : Controller
    {
        ...
        public AgendaController(AgendaTelefonicaDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Email,Telefone")] Agenda agenda)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Email,Telefone")] Agenda agenda)
        {
            if (id != agenda.Id)
            {
                return NotFound();
